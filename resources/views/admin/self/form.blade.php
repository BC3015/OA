...
<div class="row"><div class="col-md-7"><div class="box box-info">
    ...
    <ul class="nav nav-tabs">
                ...
                <a href="#tab-form-2" data-toggle="tab" id="five">
                    总体回顾 <i class="fa fa-exclamation-circle text-red hide"></i>
                </a>
            </li>
    ...
    <div class="tab-content fields-group">
                    ...
                    <div class="tab-pane active" id="tab-form-1">
                                    ...
                                    <div class="row">
    <div class="col-sm-2 "><h4 class="pull-right">本周总结</h4></div>
...
<div id="has-many-weekly" class="has-many-weekly">
    ...
    <label  style="width: 100px;" for="week_work" class="col-sm-2  control-label">任务</label>
...
<div id="has-many-week_task_agents" class="has-many-week_task_agents" type="1">
    ...
    <div class="form-group">
        <label class="col-sm-2  control-label"></label>
        <div class="col-sm-8">
            <div class="add btn btn-success btn-sm"><i class="fa fa-save"></i>&nbsp;新增总结</div>
        </div>
    </div>
    ...
    <div class="col-md-8">
        ...
        <div class="btn-group pull-right">
            <button type="button" id="submit" class="btn btn-primary">保存并预览</button>
        </div>
...
<div class="col-md-5">
    ...
    <div>
        <ul class="nav nav-pills">
          <li class="active"><a href="#" id="historical_review">历史周报</a></li>
          <li><a href="#" id="task_list">任务列表</a></li>
          <li class="disabled"><a href="#">PHP</a></li>
          <li class="disabled"><a href="#">Python</a></li>
          <li class="disabled"><a href="#">naver</a></li>
        </ul>
    </div>  
    <div id="content" style="height: 650px;overflow:auto;">
        <div class="btn-group" style="padding-top: 10px;padding-left: 10px">
            <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">选择历史周报进行查看
                <span class="caret"></span>
            </button>
            <ul class="dropdown-menu" role="menu">
                @foreach ($weekly_list as $weekly_list)
                    <li><a href="#" class="get_weekly" weekly="{{$weekly_list['id']}}">第{{$weekly_list['week_no']}}周周报</a></li>
                @endforeach
                    <li class="divider"></li>
...
$('.get_weekly').on("click",function(){
    var weekly_id=$(this).attr('weekly');
    $.ajax({
        type: 'POST',//方法类型
        dataType: 'json',//预期服务器返回的数据类型
        url: "get_info" ,//url
        data: {weekly_id:weekly_id},
